...
function Autoplay(userOptions: AutoplayOptionsType = {}): AutoplayType {
  Autoplay.globalOptions = Autoplay.globalOptions || undefined
...
export const globalOptions: AutoplayOptionsType | undefined = undefined
